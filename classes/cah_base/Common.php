	...
	public function getPathInfo() 
	{
		return array(
			...
			'live' => array(
				...
				'images_ex' => "/images/extensions",
				'classes_controllers' => "cah_controllers",
				'absolute' => "/home/users/web/b937/moo.halfnerdcom/coleandheather",
				'db_host' => "halfnerdcom.fatcowmysql.com",
				'db_pass' => "passwd1000!",
				'db_user' => "cah_user",
				'db_name' => "cah"
	...
	public static function getHtml( $cmd, $vars = array() )
	{
		switch( strtolower( $cmd ) )
		{
			...
			case "display-grid":
				...
				$table_style = ( array_key_exists( "table_style", $vars ) ) ? $vars['table_style'] : '';
				$table_classes = ( array_key_exists( "table_classes", $vars ) ) ? $vars['table_classes'] : '';
				
				$html = '
				<table ' . $table_classes . ' ' . $table_style . '>
				';
				...
				if( $num_records > 0 )
				{
					...
					<tr>			
						...
						$content = $active_controller->getHtml( $html_cmd, array( 'active_record' => $active_record, 'options' => $html_vars ) );
